...
#vv <- c(SalePrice, LotArea, YearBuilt, YearRemodAdd, BsmtFinSF1, TotalBsmtSF, X1stFlrSF, X2ndFlrSF, GarageArea, WoodDeckSF)

#vv <- c(SalePrice, OverallQual, OverCondition, LotArea, YearBuilt, YearRemodAdd, BsmtFinSF1, TotalBsmtSF, X1stFlrSF, X2ndFlrSF, GarageArea, FirePlaces, BedroomAbvGr, ScreenPorch)
...
df6 <- dplyr::select(df.scaled, c(SalePrice, OverallQual, OverCondition, LotArea, YearBuilt, YearRemodAdd, BsmtFinSF1, TotalBsmtSF, X1stFlrSF, X2ndFlrSF, GarageArea, FirePlaces, BedroomAbvGr, ScreenPorch))
...
test_df6 <- dplyr::select(test.scaled, c(SalePrice, OverallQual, OverCondition, LotArea, YearBuilt, YearRemodAdd, BsmtFinSF1, TotalBsmtSF, X1stFlrSF, X2ndFlrSF, GarageArea, FirePlaces, BedroomAbvGr, ScreenPorch))
